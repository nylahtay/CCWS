...
<form action="?" method="post" class="row g-3">
  <div class="col-md-6">
    ...
    <input type="text" class="form-control" placeholder="First Name" name="guest[FirstName]" id="guestFirstName">
  </div>
  <div class="col-md-6">
    <label for="guestLastName" class="form-label">Last</label>
    <input type="text" class="form-control" placeholder="Last Name" name="guest[LastName]" id="guestLastName">
  </div>
  <div class="col-6">
